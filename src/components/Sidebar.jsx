  ...
  return (
    <ul className='mt-12'>
      ...
      <PrivateComponent roleList={['ADMINISTRADOR', 'LIDER']}>
        <SidebarRoute to='/inscripciones' title='Aprobacion Inscripciones' icon='fas fa-thumbs-up' />
      </PrivateComponent>
...
const Logout = () => {
  ...
  return (
    <li onClick={() => deleteToken()}>
      <NavLink to='/auth/login' className='sidebar-route text-red-900'>
...
const Logo = () => {
  return (
    <div className='py-3 w-full flex flex-col items-center justify-center'>
      ...
      <span className='my-2 text-xl font-bold text-center'>Gestión de Proyectos Turing</span>
    </div>
  );
};
  ...
  return (
    <li>
      <NavLink
        ...
        className={({ isActive }) =>
          isActive
            ? 'sidebar-route text-white bg-blue-900'
